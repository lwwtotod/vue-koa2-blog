...
function ArticleList(props) {
  ...
  const delVideoAction = id => {
    console.log(id)
    confirm({
      title: '确定要删除这个视频吗?',
      content: '如果你点击OK按钮，视频将永远被删除，无法恢复。',
      onOk() {
        axios(servicePath.delVideobyId + id, { withCredentials: true }).then(
          res => {
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        >
          <div>
            ...
            <div style={{ marginBottom: 16 }}>
              <Button type="primary" onClick={saveVideo} block>
                确认完成{' '}
              </Button>
            </div>
          </div>
