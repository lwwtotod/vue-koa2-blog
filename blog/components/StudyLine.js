    ...
    <div className=" comm-box">
      ...
      <a href="https://jspang.com/detailed?id=56" target="_blank">
        <Row className="sl-row">
          <Col span={14} className="sl-title">
            <Icon type="book" /> React学习路线
          </Col>
          <Col span={8} className="sl-title1">
            基础到实战
          </Col>
          <Col span={2} className="sl-icon">
            <Icon type="right" />
          </Col>
        </Row>
      </a>
